...
public class ConvexArTest : MonoBehaviour
{
    ...
    public void CreateConvexAndMesh()
    {
    ...
    //Currently by the looks of it creates mesh only after certain vector threshold and convex with mesh is a mess
}