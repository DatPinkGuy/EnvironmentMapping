...
public class PointOctreeNode<T> {
	...
	public readonly List<OctreeObject> objects = new List<OctreeObject>(); //Made public by Alex

	// Child nodes, if any
	public PointOctreeNode<T>[] children = null; //Made public by Alex

	public bool HasChildren { get { return children != null; } } //Made public by Alex
	...
	public const int NUM_OBJECTS_ALLOWED = 8; //Made public by Alex

	// For reverting the bounds size after temporary changes
	Vector3 actualBoundsSize;

	// An object in the octree
	public class OctreeObject { //Made public by Alex
		public T Obj;
		public Vector3 Pos;
	}
